...
public class TravelDetails extends BasePage{
	...
	@FindBy(xpath="//div[@class='MuiPickersDateRangeDay-rangeIntervalPreview']/button[@aria-label='Mar 11, 2024']")
	...
	@FindBy(xpath="//div[@class='MuiPickersDateRangeDay-rangeIntervalPreview']/button[@aria-label='Mar 24, 2024']")
	...
	public void MobileNumber() throws IOException
	{
		...
		p.load(file);
		MobileNumber.sendKeys(p.getProperty("phone"));
		Slider.click();
		Plans.click();
